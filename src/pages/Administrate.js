...
export const Administrate = () => {
    ...
    const updexe = (id) => {
        if (exeName.length > 0 && exeMobNo.length == 10) {
            ...
            alert("Enter Doctor name and Mobile Number");
        }
    };
            ...
            <div className='bck'>
                <div >
                    ...
                    <div class='profile'>
                        ...
                        />
                        <button className='buttuu' onClick={addExe}>Add Doctor</button>

                    </div>

                    <div class='profile'>
                        <button className='buttuu' onClick={showExes}>Show Doctors</button>
                        <div className='table'>
                            <Card>
                                <DataTable
                ...
                <div>
                    ...
                    <div class='profile'>
                        ...
                        />
                        <button className='buttuu' onClick={addVeh}>Add Animal</button>
                        <br></br>
                    </div>

                    <div class='profile'>
                        <button className='buttuu' onClick={showVeh}>Show Animals</button>
                        <div className='table'>
                            <Card>
                                <DataTable
